...
// Note: Ensure these are wired into your route's export async function action({ request })
// ==========================================
...
export async function deleteRockhoundNamespace(admin) {
  ...
  return { success: true, intent: "deleteRockhoundNamespace", scanned: products.length, deleted: deleteIds.length };
}