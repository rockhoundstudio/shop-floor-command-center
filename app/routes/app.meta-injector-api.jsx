// ==========================================================================
// 🚨 GEMINI CRITICAL ALERT 🚨
// You pasted `app.meta-injector.injector.jsx` (TAB 1 - New Intake).
// The "Inject Metafields" button you are testing is in TAB 2 (`inspector.jsx`).
// The productUpdate mutation that writes to Shopify is in `api.jsx`.
// I have applied the typo fixes and payload guards here in Tab 1, but to fix 
// the Inject button in Tab 2, you MUST open and paste `app.meta-injector.inspector.jsx` next!
// ==========================================================================
...
=== END REPORT ===`;
  ...
  useEffect(() => {
    ...
    setSharedFields(prev => {
      ...
      // BUG 3 FIX: Enforce correct origin page handle assignment for Richardson's and typo fix
