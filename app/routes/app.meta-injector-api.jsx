  ...
  try {
    ...
    if (intent === "tab2AutoFill") {
      ...
      try {
        ...
        return Response.json({ success: true, intent: "titleParse", titleParse: payload });
      } catch (err) {
        
        const errText = err.message;
        return Response.json({ success: false, intent: "titleParse", titleParse: null, error: `Title parse error:  - ${errText}` }, { status: 500 });
      }
    }
