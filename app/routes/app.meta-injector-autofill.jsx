...
${dwellButtonsHTML}`;
      ...
      if (geminiRes.ok) {
        ...
        return Response.json({ success: true, intent, generated_description: safeParsed.generated_description });
      }
