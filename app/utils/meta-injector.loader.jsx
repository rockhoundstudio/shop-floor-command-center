  ...
  if (intent === "smartAutoFill") {
    ...
    try {
      ...
      const promptText = [
        ...
        "- color: extract the value after the label 'Flash:' in the description. Example: 'Flash: Blue' → return 'Blue'. If no Flash label exists, describe the primary color.",
        "- cut_and_shape: extract the value after the label 'Shape:' in the description. Example: 'Shape: Freeform Cabochon' → return 'Freeform Cabochon'. Do not force into a fixed list.",
