    ...
    try {
      ...
      return json({ 
        ...
        fullMetaFields: {
          ...
          treated: rockhoundMeta.treated === "true" ? "Yes" : rockhoundMeta.treated === "false" ? "No" : customMeta.treated || "",
          found_object: rockhoundMeta.found_object === "true" ? "Yes" : rockhoundMeta.found_object === "false" ? "No" : customMeta.found_object || "",
          primary_medium: rockhoundMeta.primary_medium || "Stone",
